...
const microservices_hook_controller = require('../controllers/microservices_hook.controller.js')
...
module.exports = function(webserver, controller) {
    ...
    webserver.post('/microservices/hook', (req, res) => microservices_hook_controller(req, res, controller))
